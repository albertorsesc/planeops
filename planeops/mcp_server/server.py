...
Run with `plane-mcp` (needs the `mcp` extra) or `python -m planeops.mcp_server.server`.
"""
...
def _root(repo: str | None) -> Path:
    ...
    would answer from the wrong instance and write state outside it. Same refusal rule
